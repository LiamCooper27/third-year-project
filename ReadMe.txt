...
The "virt" folder represents a virtual environment where it contains the specific needs for this project like the libraries.
The files "requirements.txt", "appengine_config.py" and "app.yaml" are used for configuration so the site can be deployed on the google cloud platform, the "lib" folder contains the main libraries used by the application so they can be used while running on the cloud.
